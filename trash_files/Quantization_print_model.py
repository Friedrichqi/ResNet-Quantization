...
for idx, resnet_model in enumerate(resnet_models):
    #sys.stdout = open(f"ptq_resnet{idx_list[idx]}_cifar{num_classes}_fc.out", "w")
    ...
    for bit in range(8, 0, -1):
        ...
        torch.save(model.state_dict(), f'qmodel/Resnet{idx_list[idx]}_CIFAR{num_classes}_fc_{bit}.pt')
