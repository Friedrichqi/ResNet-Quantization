...
# Modify the final fully connected layer to match the number of classes in CIFAR-100 (100 classes)
num_classes = 100
model.fc = nn.Linear(model.fc.in_features, num_classes)
model = model.to(device)

# Define the preprocessing pipeline for CIFAR-100
...
# Paths to the CIFAR-100 dataset
